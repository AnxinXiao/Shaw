import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as i,a,o as l}from"./app-_9vaDOHR.js";const e={};function p(t,s){return l(),i("div",null,s[0]||(s[0]=[a(`<h1 id="条件与列表渲染" tabindex="-1"><a class="header-anchor" href="#条件与列表渲染"><span>条件与列表渲染</span></a></h1><h2 id="条件渲染" tabindex="-1"><a class="header-anchor" href="#条件渲染"><span>条件渲染</span></a></h2><p>Vue 中为条件渲染提供了一组内置的指令：</p><ul><li>v-if</li><li>v-else</li><li>v-else-if</li></ul><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>&lt;template&gt;</span></span>
